{ pkgs, inputs, ... }: {
  imports = [
    ...
    #
     ./nvim/plugins/kickstart/plugins/debug.nix
     ./nvim/plugins/kickstart/plugins/indent-blankline.nix
     ./nvim/plugins/kickstart/plugins/lint.nix
     ./nvim/plugins/kickstart/plugins/autopairs.nix
    #
    # NOTE: Configure your own plugins `see https://nix-community.github.io/nixvim/`
    # Add your plugins to ./plugins/custom/plugins and import them below
     ./nvim/plugins/custom/plugins/oil.nix
     ./nvim/plugins/custom/plugins/leap.nix
     ./nvim/plugins/custom/plugins/git-blame.nix
